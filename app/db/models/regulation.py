...
class ItemRule(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    rule_set_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("rule_sets.id", ondelete="CASCADE"))
...
class Applicability(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    item_rule_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("item_rules.id", ondelete="CASCADE"))
...
class ConstraintsQuant(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    applicability_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("applicability.id", ondelete="CASCADE"))
...
class ConstraintExtra(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    constraints_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("constraints_quant.id", ondelete="CASCADE"))
...
class TaxonomySynonym(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    taxonomy_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("taxonomy.id", ondelete="CASCADE"))
...
class RegulationMatch(Base):
    ...
    image_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("item_images.image_id"))
    item_rule_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("item_rules.id", ondelete="SET NULL"))
