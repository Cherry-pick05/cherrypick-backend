...
class Trip(Base):
    ...
    trip_id: Mapped[int] = mapped_column(BIGINT, primary_key=True, autoincrement=True)
...
class TripSegment(Base):
    ...
    segment_id: Mapped[int] = mapped_column(BIGINT, primary_key=True, autoincrement=True)
    trip_id: Mapped[int] = mapped_column(BIGINT, ForeignKey("trips.trip_id", ondelete="CASCADE"))
...
class TripViaAirport(Base):
    ...
    via_id: Mapped[int] = mapped_column(BIGINT, primary_key=True, autoincrement=True)
    trip_id: Mapped[int] = mapped_column(BIGINT, ForeignKey("trips.trip_id", ondelete="CASCADE"))
